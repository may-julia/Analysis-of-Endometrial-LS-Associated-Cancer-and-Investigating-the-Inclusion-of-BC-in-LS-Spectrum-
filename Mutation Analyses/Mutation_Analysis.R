...
TCGA <- read_excel("~/Analysis/2024/EC_and_BC/TCGA.xlsx")
# Load mutation data
mutation_data <- read.delim("~/Analysis/2024/EC_and_BC/tcga_pan_can_atlas_2018/data_mutations.txt", header = TRUE, sep = "\t")

likely_LS_samples <- na.omit(TCGA$Likely_Lynch) 
likely_sporadic_samples <- na.omit(TCGA$Likely_Sporadic)
...
# number of somatically altered genes per sample ####
...
# number of somatically altered variants per sample ####
#Likely LS
...
file_path <- "~/Analysis/2024/Mutation and Copy Number Alteration Analyses/New_August_24/EC_and_BC_fishers.csv"

# Save the data frame as a CSV file
write.csv(significant_genes, file = file_path, row.names = FALSE)


file_path <- "~/Analysis/2024/Mutation and Copy Number Alteration Analyses/New_August_24/filtered_EC_and_BC_fishers.csv"
...
png("~/Analysis/2024/Mutation and Copy Number Alteration Analyses/New_August_24/enrichr_EC_and_BC.png") 
